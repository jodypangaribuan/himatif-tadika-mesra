        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img src="{{ asset('images/carousel-1.jpg') }}" class="d-block w-100" alt="Campus Event">
                ...
                <div class="carousel-item">
                    <div class="carousel-overlay"></div>
                    <img src="{{ asset('images/carousel-2.jpg') }}" class="d-block w-100" alt="Workshop">
                    <div class="carousel-caption">
                        <div class="caption-content">
                ...
                <div class="carousel-item">
                    <div class="carousel-overlay"></div>
                    <img src="{{ asset('images/carousel-3.jpg') }}" class="d-block w-100" alt="Community">
                    <div class="carousel-caption">
                        <div class="caption-content">
